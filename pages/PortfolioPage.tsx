    ...
    <>
      ...
      <div className="bg-dark-bg min-h-screen">
        <div className="container mx-auto px-6 py-20">
          ...
          <p className="text-center text-lg text-gray-400 max-w-3xl mx-auto mb-16">Olemme ylpeitä tekemistämme töistä ja saavuttamistamme tuloksista. Selaa portfolioamme nähdäksesi, miten olemme auttaneet asiakkaitamme menestymään.</p>
